...
func HandleMediaStream(upgrader websocket.Upgrader, cfg *config.Config) http.Handler {
    return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
        ...
        // disconnectCall safely terminates the call, sends required commands to Twilio
        ...
        for {
            ...
            // Ignore events if disconnecting, except "stop"
            ...
            case "start":
                ...
                // Generate configuration based on direction (this must now include tts.output_format=ulaw_8000)
                ...
                // Handle ElevenLabs messages in a goroutine
